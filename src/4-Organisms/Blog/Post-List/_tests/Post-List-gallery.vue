<template>
  <section class="post-list">
    ...
    <div class="post-list--list">
      ...
      <transition-group appear :name="transitionName" mode="out-in" tag="ul" class="row align-center small-up-2 medium-up-3">
        <li v-for="(post, index) in pagedItems" :key="post.id" class="column">
